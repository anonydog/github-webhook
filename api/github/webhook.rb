$LOAD_PATH.unshift File.expand_path(__dirname__, '/../../lib')
...
module Anonydog
  class Webhook
    ...
    def verify_signature(payload_body)
      ...
      return halt 400, "Signature doesn't check. Are you Github?" unless Rack::Utils.secure_compare(signature, request['HTTP_X_HUB_SIGNATURE'])
    end
...
Handler = Proc.new do |req, res|
  ...
  res.body = Anonydog::Webhook.new.do_hook(req)
end
